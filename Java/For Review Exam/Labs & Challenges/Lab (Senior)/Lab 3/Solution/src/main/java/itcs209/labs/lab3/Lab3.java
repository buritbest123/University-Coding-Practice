...
public class Lab3 {
    ...
    public static Rectangle createAnExampleRectangle() {
        Rectangle a = new Rectangle(10,20,42,21);
        return a;
    }
    ...
    * @return a Rectangle object
    */
   public static Rectangle createRectangle20411919() {
       Rectangle a = new Rectangle(20,41,19,19);
       return a;
   }
   ...
   {
        Rectangle a = new Rectangle(q,y,(int)1.0,(int)1.0);
       return a;
   }
   ...
   {
       double comp1 = r.getWidth();
       double comp2 = r.getHeight();
       double perimeter;
       perimeter=2*(comp1+comp2);
   ...
   {
       if (axis.equalsIgnoreCase("w") || axis.equalsIgnoreCase("W" )) {
           return r.getWidth();

   }else if(axis.equalsIgnoreCase("h") || axis.equalsIgnoreCase("H" )){
           return r.getHeight();
       }else{
   ...
   public static boolean isSameArea(Rectangle rectangle1, Rectangle s2) {
       double areas = rectangle1.getWidth() * rectangle1.getHeight();
       double areas1 = s2.getWidth() * s2.getHeight();
       if(areas == areas1)
       {
           return true;
       }else
   ...
   public static void move41R(Rectangle r) {
      r.setLocation((int)r.getX()+41,(int)r.getY());
   ...
   public static void setXYTo(Rectangle r1, Rectangle box2) {
      r1.setLocation((int)box2.getX(),(int)box2.getY());
   ...
   public static Rectangle resizeWithCopy(Rectangle s, int dw, int dh) {
       Rectangle a = new Rectangle(s);
       a.setSize ((int)a.getWidth()+dw,(int)a.getHeight()+dh);
