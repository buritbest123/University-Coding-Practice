...
public class Bank {
    ...
    public Bank(String Bank_account) { // This method gets called by runtime
        // Use this method to set name and create a list of accounts (using ArrayList to store BankAccount objects)
        name = Bank_account;
