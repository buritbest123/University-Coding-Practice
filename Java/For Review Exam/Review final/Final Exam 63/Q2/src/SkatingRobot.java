...
public class SkatingRobot extends Robot{
	...
	public SkatingRobot(String _name, int _x, int _y, char _direction) { // Constructor
		// Your code goes here
		super(_name, _x, _y);
		this.direction = _direction;
	}
	
	public SkatingRobot(String _name, char _direction) { // Another Constructor
		// Your code goes here
		super(_name);
		this.direction = _direction;
	}
	 ...
	 * 
	 * @throws  if the speed is less than or equals to 0.
	...
	public String toString() {
		// Your code goes here
		return String.format("%s is at location (%d, %d) and facing at direction %c", name, getLocX(), getLocY(), getDirection());
	}
}